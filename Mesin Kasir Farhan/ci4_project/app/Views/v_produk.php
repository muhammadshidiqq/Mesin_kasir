    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button type="button" onclick="NewWin=window.open('<?= base_url('Laporan/PrintDataProduk') ?>','NewWin','toolbar=no, width=1100,height=500,scrollbars=yes')" class="btn btn-tool"><i
        ...
        <div class="card-body">
            ...
            if (!empty($errors)) { ?>
                <div class="alert alert-danger alert-dismissible">
                    <h4>Entry Form Gagal DiTambahkan !!</h4>
                    <ul>
                    ...
                    foreach ($produk as $key => $value) { ?>
                        <tr class="<?= $value['stock'] == 0 ? 'bg-danger' : '' ?>">
                            ...
                            <td class="text-right">Rp.
                                <?= number_format($value['harga_beli'], 0) ?>
                            </td>
                            <td class="text-right">Rp.
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="kode_produk" type="number" class="form-control" value="<?= old('kode_produk') ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="harga_beli" id="harga_beli" value="<?= old('harga_beli') ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="harga_jual" id="harga_jual" value="<?= old('harga_jual') ?>"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="">Kode Produk</label>
                            <input name="kode_produk" type="number" class="form-control"
                                value="<?= $value['kode_produk'] ?>" placeholder="Kode Produk" readonly>
                        </div>

                        <div class="form-group">
                            <label for="">Nama_Produk</label>
                            <input name="nama_produk" class="form-control" value="<?= $value['nama_produk'] ?>"
                                placeholder="Nama Produk" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input name="harga_beli" id="harga_beli<?= $value['id_produk'] ?>"
                                    value="<?= $value['harga_beli'] ?>" class="form-control" placeholder="Harga Beli"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input name="harga_jual" id="harga_jual<?= $value['id_produk'] ?>"
                                        value="<?= $value['harga_jual'] ?>" class="form-control" placeholder="Harga Jual"
                                        required>
                                </div>

                                <div class="form-group">
                                    <label for="">Stock</label>
                                    <input name="stock" type="number" value="<?= $value['stock'] ?>" class="form-control"
                                        placeholder="Stock" required>
                                </div>
