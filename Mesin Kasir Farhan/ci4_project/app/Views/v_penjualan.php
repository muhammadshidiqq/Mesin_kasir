...
<body class="hold-transition layout-top-nav">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="../../index3.html" class="navbar-brand">
                    <span class="brand-text font-weight-light"><i class="fas fa-shopping-cart text-primary"></i><b>
                            Transaksi Penjualan</b></span>
                </a>
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    <li class="nav-item">
                        <?php if (session()->get('level') == '1') { ?>
                            <a class="nav-link" href="<?= base_url('Adminn') ?>">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <label class="form-control form-control-lg text-center text-primary">
                                                <?= date('d M Y') ?>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            <label>Jam</label>
                                            <label class="form-control form-control-lg text-center text-danger"
                                                id="jam">
                                            </label>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body bg-black color-palette text-right">
                                <label class="display-4 text-green">Rp.
                                        ...
                                        <div class="row">
                                            <div class="col-2 input-group">
                                                <input name="kode_produk" id="kode_produk" class="form-control"
                                                    placeholder="Kode Produk" autocomplete="off">
                                            ...
                                            <div class="col-1">
                                                <input id="qty" type="number" min="1" value="1" name="qty"
                                                    class="form-control text-center" placeholder="QTY">
                                            </div>
                                            <input name="harga_beli" type="hidden">
                                            <div class="col-3">
                                                <button type="submmit" class="btn btn-primary btn-flat"><i
                                                        class="fas fa-cart-plus">Add</i></button>
                                                <a href="<?= base_url('Penjualan/ResetCart') ?>"
                                                    class="btn btn-warning btn-flat"><i
                                                        class="fas fa-sync"></i>Reset</a>
                                                <a class="btn btn-success btn-flat"><i class="fas fa-cash-register"
                                                        data-toggle="modal" data-target="#pembayaran"
                                                        onclick="Pembayaran()">Pembayaran</i></a>
                                            </div>
                                        </div>
                                        <?php echo form_close() ?>
                                    </div>
                                                ...
                                                <?php foreach ($cart as $key => $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <?= $value['qty'] ?>
                                                            <?= $value['options']['nama_satuan'] ?>
                                                        </td>
                                                        <td class="text-right">Rp.
                                                            <?= number_format($value['subtotal'], 0) ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="<?= base_url('Penjualan/RemoveItemCart/' . $value['rowid']) ?>"
                        ...
                        <tbody>
                            ...
                            foreach ($produk as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td><button onclick="PilihProduk( <?= $value['kode_produk'] ?>)"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="grand_total" id="grand_total" value=" <?= number_format($grand_total, 0) ?>"
                                class="form-control form-control-lg text-right text-danger" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="dibayar" id="dibayar"
                                class="form-control form-control-lg text-right text-success" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="kembalian" id="kembalian"
                                class="form-control form-control-lg text-right text-primary" readonly>
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save">Save Transaksi</i></button>
                </div>
                <?php echo form_close() ?>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">M.Pati Farhan</a>.</strong> All rights
        reserved.
    </footer>
    </div>
    <!-- ./wrapper -->
                ...
                success: function (response) {
                    if (response.nama_produk == '') {
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Kode Produk Tidak Terdaftar Di Database !!!',
                        });
                    } else {
