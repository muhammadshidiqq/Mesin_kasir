                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <span class="input-group-append">
                            <button onclick="ViewTabelLaporan()" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#cari_produk">
                                <i class="fas fa-sharp fa-solid fa-file-invoice"></i>View Laporan
                            </button>
