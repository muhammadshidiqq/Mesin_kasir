  ...
  <div class="info-box mb-3 bg-navy">
    ...
    <div class="info-box-content">
      ...
      <span class="info-box-number">Rp
        <?= $p_hari_ini == null ? 0 : number_format($p_hari_ini['total_harga'], 0) ?>
      </span>
    </div>
    <!-- /.info-box-content -->
  </div>
...
<div class="col-md-4">
  ...
  <div class="info-box mb-3 bg-fuchsia">
    ...
    <div class="info-box-content">
      ...
      <span class="info-box-number">Rp
      <?= $p_bulan_ini == null ? 0 : number_format($p_bulan_ini['total_harga'], 0) ?>
      </span>
    </div>
    <!-- /.info-box-content -->
  </div>
...
<div class="col-md-4">
  ...
  <div class="info-box mb-3 bg-indigo">
    ...
    <div class="info-box-content">
      ...
      <span class="info-box-number">Rp
      <?= $p_tahun_ini == null ? 0 : number_format($p_tahun_ini['total_harga'], 0) ?>
      </span>
    </div>
    <!-- /.info-box-content -->
  </div>
